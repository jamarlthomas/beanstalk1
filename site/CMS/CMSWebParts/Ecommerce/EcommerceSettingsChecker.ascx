<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_Ecommerce_EcommerceSettingsChecker" Codebehind="~/CMSWebParts/Ecommerce/EcommerceSettingsChecker.ascx.cs" %>
