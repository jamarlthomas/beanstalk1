<%@ Control Language="C#" AutoEventWireup="true" Codebehind="~/CMSWebParts/Wireframe/WireframeListComponent.ascx.cs" Inherits="CMSWebParts_Wireframe_WireframeListComponent" %>
