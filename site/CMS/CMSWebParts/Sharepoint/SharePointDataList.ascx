<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_SharePoint_SharePointDataList" Codebehind="~/CMSWebParts/SharePoint/SharePointDataList.ascx.cs" %>
