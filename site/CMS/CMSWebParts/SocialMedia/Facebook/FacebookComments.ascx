<%@ Control Language="C#" AutoEventWireup="true" Codebehind="~/CMSWebParts/SocialMedia/Facebook/FacebookComments.ascx.cs" Inherits="CMSWebParts_SocialMedia_Facebook_FacebookComments" %>
