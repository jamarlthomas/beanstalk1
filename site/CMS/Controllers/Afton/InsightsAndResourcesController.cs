...
{
    public class InsightsAndResourcesController : SidebarPageController
    {
        ...
        public ActionResult Index()
        {
            ...
            model.InsightsListing = new List<InsightsListingItemViewModel>
            {
                new InsightsListingItemViewModel
                {
                    ...
                    Links =
                        MapData<SolutionBusinessUnit, LinkViewModel>(
                            _solutionBusinessUnitProvider.GetSolutionBusinessUnits())
                }
            };
            ...
            model.Tiles = _resourceTileProvider.GetTiles(page.FeaturedContentList, page.Site.DisplayName).Select(s => Mapper.Map<TileViewModel>(s)).ToList();
            model.SideBar.Items = MapSidebar(_sidebarProvider.GetSideBarItems(StringToGuidsConvertHelper.ParseGuids(page.SidebarItems)), page);
