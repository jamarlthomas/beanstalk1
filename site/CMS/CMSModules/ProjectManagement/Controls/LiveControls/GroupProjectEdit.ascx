<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_ProjectManagement_Controls_LiveControls_GroupProjectEdit" Codebehind="GroupProjectEdit.ascx.cs" %>
