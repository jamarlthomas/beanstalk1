<%@ Control Language="C#" AutoEventWireup="true" Codebehind="NewsletterOpen.ascx.cs" Inherits="CMSModules_ContactManagement_Controls_UI_ActivityDetails_NewsletterOpen" %>
