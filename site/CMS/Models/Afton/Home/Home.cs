    ...
    public partial class Home : TreeNode
    {
        ...
        public partial class HomeFields
        {
            ...
            public string ManagedBlocks
            {
                get
                {
                    return mInstance.ManagedBlocks;
                }
                set
                {
                    mInstance.ManagedBlocks = value;
                }
            }


            /// <summary>
            /// Used to select the top three tiles on the homepage.
            /// </summary>
            public IEnumerable<TreeNode> ManagedBlocks2
            {
                get
                {
                    return mInstance.GetRelatedDocuments("ManagedBlocks2");
                }
            }
        }
